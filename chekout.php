...
<div class="display-order">
    ...
    ?>
    <span class="grand_total">Grand total: <?= $grand_total; ?> Dh</span>
</div>
<div class="container">
...
<?php
    if(isset($_POST['order'])){
        ...
        $method = $_POST['method'];
        $cart = $conn->prepare("SELECT * FROM cart");
        $cart->execute();
        $products_total = 0;
        $product_name = [];
        $product_price = [];
        ...
        $sql = $conn->prepare("INSERT INTO orders(name,email,method,city,country,adress,pin_code,total_products,total_price)
